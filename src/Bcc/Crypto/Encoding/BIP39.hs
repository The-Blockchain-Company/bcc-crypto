...
module Bcc.Crypto.Encoding.BIP39
    ( bccSlSeed
    , module X
    ) where
...
--
-- This function is the function used in `bcc-sl` (and Klarity) to
-- generate a seed from a given mnemonic list.
--
-- https://github.com/The-Blockchain-Company/bcc-sl/blob/f5b8073b92b8219ae5fbb038c0ceb4a19502a86b/wallet/src/Pos/Util/BackupPhrase.hs#L59-L65
-- https://github.com/The-Blockchain-Company/bcc-sl/blob/429efc2426c63802ae86789f5b828dcbb42de88a/wallet/src/Pos/Util/Mnemonics.hs#L66-L87
--
bccSlSeed :: forall n csz mw . ConsistentEntropy n mw csz
              => Proxy n
              -> MnemonicSentence mw
              -> Maybe Seed
bccSlSeed _ mw =
