...
import           Bcc.Crypto.Wallet.Encrypted
import qualified Bcc.Crypto.Wallet.Pure as PureWallet
...
import qualified Bcc.Crypto.Encoding.Seed as PW

import qualified Test.Crypto as Crypto
import qualified Test.Bcc as Bcc
...
main :: IO ()
main = defaultMain $ Group "bcc-crypto"
